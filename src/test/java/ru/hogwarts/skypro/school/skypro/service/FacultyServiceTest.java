package ru.hogwarts.skypro.school.skypro.service;
...
class FacultyServiceTest {
    ...
    void testRemove() {
        ...
        service.remove(faculty.getId());
        assertNull(service.get(faculty.getId()));
    }

    @Test
    void testUpdate() {
        var result1 = service.update(new Faculty(9999L, "updated", "updated_color"));
        assertNull(result1);
